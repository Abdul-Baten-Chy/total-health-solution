    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-2xl">
          <h1 className="mb-5 text-3xl md:text-5xl font-extrabold font-head text-white text-[70px]"> Welcome To <br /> Health Care <span className="text-[#66eb8e]">Solution </span>  </h1>
